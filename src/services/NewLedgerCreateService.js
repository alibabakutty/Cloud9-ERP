...
// Function to retrieve data for a specific ledger by ledgername
export const getLedgerDataByLedgerName = (ledger) => {
    return axios.get(`${REST_API_BASE_URL}/${ledgerName}`);
};