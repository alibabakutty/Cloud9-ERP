...
const SundryDebtorsGroup = () => {
  return (
    <div>

<div class="stock-group">
        <div class="master-creation">
            <p>Sundry Debtors Group</p>
        </div>

        <div class="content">
            <div class="left-part">
                <form id="myForm" action="addSundryDebtors" method="post" onsubmit="return confirmSubmission();">
                    
                    <div class="input-grp">
                        <label for="groupName">Name </label>
                        :<input type="text" id="groupName" name="groupName" required value="Sundry Debtors" />
                    </div>
...
export default SundryDebtorsGroup