...
const PaymentVoucherCreation = () => {
  return (
    <div>

<div class="container">
        <div class="master-creation">
            <p>Payment Voucher Creation</p>
        </div>
            ...
            <form id="myForm" action="addVoucher" method="post" onsubmit="return confirmSubmission();">
                ...
                <div class="left-part">
                    <div class="input-grp">
                        ...
                        :<input type="text" id="voucherName" name="voucherName" required value="Payment" />
                    </div>
                ...
                <div class="right-part">
                    <div class="general">
                        ...
                        <div class="input-grp">
                            ...
                            :<input type="text" id="typeOfVoucher" name="typeOfVoucher" required value="Payment" />
                        </div>
        
                        <div class="input-grp">
                            <label for="abbreviation">Abbreviation </label>
                            :<input type="text" id="abbreviation" name="abbreviation" required value="Pymt" />
                        </div>
