...
const ReversingJournalVoucherCreate = () => {
  return (
    <div>
...
<div class="stock-group">
        <div class="master-creation">
            <p>Reversing Journal Voucher Creation</p>
        </div>

        <div class="content">
            <form id="myForm" action="addReversingJournal" method="post" onsubmit="return confirmSubmission();">
                    
                <div class="left-part">
                    <div class="input-grp">
                        <label for="voucherName">Name : </label>
                        <input type="text" id="voucherName" name="voucherName" required value="Reversing Journal" />
                    </div>
                ...
                <div class="right-part">
                    <div class="general">
                        ...
                        <div class="input-grp">
                            ...
                            <input type="text" id="typeOfVoucher" name="typeOfVoucher" required value="Reversing Journal" />
                        </div>
        
                        <div class="input-grp">
                            <label for="abbreviation">Abbreviation : </label>
                            <input type="text" id="abbreviation" name="abbreviation" required value="Rev Jrnl" />
                        </div>
...
export default ReversingJournalVoucherCreate