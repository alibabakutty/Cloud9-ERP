...
const MiscExpensesASSETGroup = () => {
  return (
    <div>

<div class="stock-group">
        <div class="master-creation">
            <p>Misc. Expenses (ASSET) Group</p>
        </div>

        <div class="content">
            <div class="left-part">
                <form id="myForm" action="addMiscExpense" method="post" onsubmit="return confirmSubmission();">
                    
                    <div class="input-grp">
                        <label for="groupName">Name </label>
                        :<input type="text" id="groupName" name="groupName" required value="Misc. Expenses (ASSET)" />
                    </div>
                    ...
                    <div class="input-grp">
                        ...
                        :<input type="text" id="natureOfGroup" name="natureOfGroup" required value="Assets" />
                    </div>
                    ...
                    <div class="input-grp">
                        <label for="nettDebitOrCreditBalancesForReporting">Nett Debit/Credit Balance for Reporting </label>
...
export default MiscExpensesASSETGroup