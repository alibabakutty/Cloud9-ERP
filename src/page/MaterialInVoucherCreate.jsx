...
const MaterialInVoucherCreate = () => {
  return (
    <div>

<div class="container">
        <div class="master-creation">
            <p>Material In Voucher Creation</p>
        </div>

        <div class="content">
            <form id="myForm" action="addVoucher" method="post" onsubmit="return confirmSubmission();">
                    
                <div class="left-part">
                    <div class="input-grp">
                        <label for="voucherName">Name </label>
                        :<input type="text" id="voucherName" name="voucherName" required value="Material In" />
                    </div>
                ...
                <div class="right-part">
                    <div class="general">
                        ...
                        <div class="input-grp">
                            ...
                            :<input type="text" id="typeOfVoucher" name="typeOfVoucher" required value="Material In" />
                        </div>
        
                        <div class="input-grp">
                            <label for="abbreviation">Abbreviation </label>
                            :<input type="text" id="abbreviation" name="abbreviation" required value="Mat In" />
                        </div>
                        ...
                        <div class="input-grp">
                            <label for="showUnusedVoucherNumbersInTransactions">Show Unused Voucher Numbers <br /> In Transactions Retain Original Voucher </label>
                        ...
                        <div class="input-grp">
                            <label for="useForJobWork">Use for Job Work </label>
                            :<input type="text" id="useForJobWork" name="useForJobWork" required value="No" />
                        </div>
...
export default MaterialInVoucherCreate