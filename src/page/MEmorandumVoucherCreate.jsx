...
const MEmorandumVoucherCreate = () => {
  return (
    <div>

<div class="container">
        <div class="master-creation">
            <p>Memorandum Voucher Creation</p>
        </div>
            ...
            <form id="myForm" action="addVoucher" method="post" onsubmit="return confirmSubmission();">
                ...
                <div class="left-part">
                    <div class="input-grp">
                        ...
                        :<input type="text" id="voucherName" name="voucherName" required value="Memorandum" />
                    </div>
                ...
                <div class="right-part">
                    <div class="general">
                        ...
                        <div class="input-grp">
                            ...
                            :<input type="text" id="typeOfVoucher" name="typeOfVoucher" required value="Memorandum" />
                        </div>
        
                        <div class="input-grp">
                            <label for="abbreviation">Abbreviation </label>
                            :<input type="text" id="abbreviation" name="abbreviation" required value="Memo" />
                        </div>
                        ...
                        <div class="input-grp">
                            <label for="allowNarrationsInVoucher">Allow Narration In Voucher </label>
                            :<input type="text" id="allowNarrationsInVoucher" name="allowNarrationsInVoucher" required value="Yes" />
                        </div>
...
export default MEmorandumVoucherCreate