...
const SecuredLoansGroup = () => {
  return (
    <div>

<div class="stock-group">
        <div class="master-creation">
            <p>Secured Loans Group</p>
        </div>

        <div class="content">
            <div class="left-part">
                <form id="myForm" action="addSecuredLoan" method="post" onsubmit="return confirmSubmission();">
                    
                    <div class="input-grp">
                        <label for="groupName">Name </label>
                        :<input type="text" id="groupName" name="groupName" required value="Secured Loans" />
                    </div>
...
export default SecuredLoansGroup