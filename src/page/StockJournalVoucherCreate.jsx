...
const StockJournalVoucherCreate = () => {
  return (
    <div>

<div class="container">
        <div class="master-creation">
            <p>Stock Journal Voucher Creation</p>
        </div>

        <div class="content">
            <form id="myForm" action="addStockJournal" method="post" onsubmit="return confirmSubmission();">
                    
                <div class="left-part">

                    <div class="input-grp">
                        <label for="voucherName">Name : </label>
                        <input type="text" id="voucherName" name="voucherName" required value="Stock Journal" />
                    </div>
                ...
                <div class="right-part">
                    <div class="general">
                        ...
                        <div class="input-grp">
                            ...
                            <input type="text" id="typeOfVoucher" name="typeOfVoucher" required value="Stock Journal" />
                        </div>
        
                        <div class="input-grp">
                            <label for="abbreviation">Abbreviation : </label>
                            <input type="text" id="abbreviation" name="abbreviation" required value="Stk Jrnl" />
                        </div>
                        ...
                        <div class="input-grp">
                            <label for="useAsAManufacturingJournal">Use as a Manufacturing Journal : </label>
                            <input type="text" id="useAsAManufacturingJournal" name="useAsAManufacturingJournal" required value="No" />
                        </div>
        
                        <div class="input-grp">
                            <label for="trackAdditionalCostsForPurchases">Track Additional Cists for Purchases : </label>
...
export default StockJournalVoucherCreate