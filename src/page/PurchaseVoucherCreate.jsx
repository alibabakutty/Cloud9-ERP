...
const PurchaseVoucherCreate = () => {
  return (
    <div>

<div class="container">
        <div class="master-creation">
            <p>Purchase Voucher Creation</p>
        </div>

        <div class="content">
            <form id="myForm" action="addPurchase" method="post" onsubmit="return confirmSubmission();">
                    
                <div class="left-part">
                    <div class="input-grp">
                        <label for="voucherName">Name : </label>
                        <input type="text" id="voucherName" name="voucherName" required value="Purchase" />
                    </div>
                ...
                <div class="right-part">
                    <div class="general">
                        ...
                        <div class="input-grp">
                            ...
                            <input type="text" id="typeOfVoucher" name="typeOfVoucher" required value="Purchase" />
                        </div>
        
                        <div class="input-grp">
                            <label for="abbreviation">Abbreviation : </label>
                            <input type="text" id="abbreviation" name="abbreviation" required value="Purc" />
                        </div>
                        ...
                        <div class="input-grp">
                            <label for="showUnusedVoucherNumbersInTransactions">Show Unused Voucher Numbers In Transactions <b />Retain Original Voucher : </label>
                        ...
                        <div class="input-grp">
                            <label for="enableDefaultAccountingAlocations">Enable Default Accounting Allocations : </label>
                            <input type="text" id="enableDefaultAccountingAlocations" name="enableDefaultAccountingAlocations" required value="No" />
                        </div>
...
export default PurchaseVoucherCreate