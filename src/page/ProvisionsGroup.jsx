...
const ProvisionsGroup = () => {
  return (
    <div>

<div class="stock-group">
        <div class="master-creation">
            <p>Provisions Group</p>
        </div>

        <div class="content">
            <div class="left-part">
                <form id="myForm" action="addProvision" method="post" onsubmit="return confirmSubmission();">
                    
                    <div class="input-grp">
                        <label for="groupName">Name </label>
                        :<input type="text" id="groupName" name="groupName" required value="Provisions" />
                    </div>
...
export default ProvisionsGroup