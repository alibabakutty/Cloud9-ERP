...
const ReceiptNoteVoucherCreate = () => {
  return (
    <div>

<div class="container">
        <div class="master-creation">
            <p>Receipt Note Voucher Creation</p>
        </div>

        <div class="content">
            <form id="myForm" action="addReceiptNote" method="post" onsubmit="return confirmSubmission();">
                    
              <div class="left-part">
                <div class="input-grp">
                    <label for="voucherName">Name </label>
                    :<input type="text" id="voucherName" name="voucherName" required value="Receipt Note" />
                </div>
                ...
                <div class="right-part">
                    <div class="general">
                        ...
                        <div class="input-grp">
                            ...
                            :<input type="text" id="typeOfVoucher" name="typeOfVoucher" required value="Receipt Note" />
                        </div>
        
                        <div class="input-grp">
                            <label for="abbreviation">Abbreviation </label>
                            :<input type="text" id="abbreviation" name="abbreviation" required value="Rcpt Note" />
                        </div>
...
export default ReceiptNoteVoucherCreate