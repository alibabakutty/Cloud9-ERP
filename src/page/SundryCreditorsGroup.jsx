...
const SundryCreditorsGroup = () => {
  return (
    <div>

<div class="stock-group">
        <div class="master-creation">
            <p>Sundry Creditors Group</p>
        </div>

        <div class="content">
            <div class="left-part">
                <form id="myForm" action="addSundryCreditors" method="post" onsubmit="return confirmSubmission();">
                    
                    <div class="input-grp">
                        <label for="groupName">Name </label>
                        :<input type="text" id="groupName" name="groupName" required value="Sundry Creditors" />
                    </div>
                    ...
                    <div class="input-grp">
                        ...
                        :<input type="text" id="underGroup" name="underGroup" required value="Current Liabilities" />
                    </div>
                    ...
                    <div class="input-grp">
                        ...
                        :<input type="text" id="groupBehavesLikeASubledger" name="groupBehavesLikeASubledger" required value="Yes" />
                    </div>
...
export default SundryCreditorsGroup