...
<div class="container">
        <div class="master-creation">
            <p>Receipt Voucher Creation</p>
        </div>

        <div class="content">
            <form id="myForm" action="addReceipt" method="post" onsubmit="return confirmSubmission();">
                    
                <div class="left-part">
                    <div class="input-grp">
                        <label for="voucherName">Name  </label>
                        :<input type="text" id="voucherName" name="voucherName" required value="Receipt" />
                    </div>
                ...
                <div class="right-part">
                    <div class="general">
                        ...
                        <div class="input-grp">
                            ...
                            :<input type="text" id="typeOfVoucher" name="typeOfVoucher" required value="Receipt" />
                        </div>
        
                        <div class="input-grp">
                            <label for="abbreviation">Abbreviation  </label>
                            :<input type="text" id="abbreviation" name="abbreviation" required value="Rcpt" />
                        </div>
                    ...
                    <div class="printing">
                        ...
                        <div class="input-grp">
                            ...
                            :<input type="text" id="printFormalReceiptAfterSaving" name="printFormalReceiptAfterSaving" required value="No" />
                        </div>
                    </div>
...
export default ReceiptVoucherCreate