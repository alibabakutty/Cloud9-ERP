...
const SalesAccountGroup = () => {
  return (
    <div>

<div class="stock-group">
        <div class="master-creation">
            <p>Sales Accounts Group</p>
        </div>

        <div class="content">
            <div class="left-part">
                <form id="myForm" action="addSalesAccount" method="post" onsubmit="return confirmSubmission();">
                    
                    <div class="input-grp">
                        <label for="groupName">Name </label>
                        :<input type="text" id="groupName" name="groupName" required value="Sales Accounts" />
                    </div>
                    ...
                    <div class="input-grp">
                        ...
                        :<input type="text" id="natureOfGroup" name="natureOfGroup" required value="Income" />
                    </div>

                    <div class="input-grp">
                        <label for="doesItAffectGrossProfits">Does It Affect Gross Profits </label>
                        :<input type="text" id="doesItAffectGrossProfits" name="doesItAffectGrossProfits" required value="Yes" />
                    </div>
...
export default SalesAccountGroup