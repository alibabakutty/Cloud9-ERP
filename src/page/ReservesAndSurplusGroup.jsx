...
const ReservesAndSurplusGroup = () => {
  return (
    <div>

<div class="stock-group">
        <div class="master-creation">
            <p>Reserves & Surplus</p>
        </div>

        <div class="content">
            <div class="left-part">
                <form id="myForm" action="addReservesAndSurplus" method="post" onsubmit="return confirmSubmission();">
                    
                    <div class="input-grp">
                        <label for="groupName">Name </label>
                        :<input type="text" id="groupName" name="groupName" required value="Reserves & Surplus" />
                    </div>

                    <div class="input-grp">
                        <label for="groupAlias">Alias </label>
                        :<input type="text" id="groupAlias" name="groupAlias" required value="Retained Earnings" />
                    </div>

                    <div class="input-grp">
                        <label for="underGroup">Under </label>
                        :<input type="text" id="underGroup" name="underGroup" required value="Capital Account" />
                    </div>
...
export default ReservesAndSurplusGroup