...
const MaterialOutVoucherCreate = () => {
  return (
    <div>

<div class="container">
        <div class="master-creation">
            <p>Material Out Voucher Creation</p>
        </div>
            ...
            <form id="myForm" action="addVoucher" method="post" onsubmit="return confirmSubmission();">
                ...
                <div class="left-part">
                    <div class="input-grp">
                        ...
                        :<input type="text" id="voucherName" name="voucherName" required value="Material Out" />
                    </div>
                ...
                <div class="right-part">
                    <div class="general">
                        ...
                        <div class="input-grp">
                            ...
                            :<input type="text" id="typeOfVoucher" name="typeOfVoucher" required value="Material Out" />
                        </div>
        
                        <div class="input-grp">
                            <label for="abbreviation">Abbreviation </label>
                            :<input type="text" id="abbreviation" name="abbreviation" required value="Mat Out" />
                        </div>
...
export default MaterialOutVoucherCreate