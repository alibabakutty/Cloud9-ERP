        ...
        switch(newValue) {
            ...
            case "Cash-in-Hand":
                ...
                case "Loans (Liability)":
                    showElements(["costsCentresAreApplicable", "headUnder", "includeInAssessableValueCalculation", "stateName", "countryName", "pinCode", "headUnderFive", "provideBankDetails", "registrationType", "gstOrUin", "setOrAlterGstDetails"]);
                    break;
                ...
                case "Unsecured Loans":
                    showElements(["costsCentresAreApplicable", "headUnder", "includeInAssessableValueCalculation", "stateName", "countryName", "pinCode", "registrationType", "gstOrUin", "setOrAlterGstDetails"
                    ]);
                    break;
            default:
                showElements([
                        ...
                        <div className='middle-box flex'>
                            <div className='input-ldgr  border w-1/2 text-sm'>
                                ...
                                <div className='ml-2'>
                                    ...
                                    : <select name="underGroup" id="underGroup" className='w-[185px] font-semibold h-5 outline-none focus:bg-yellow-200 focus:border border border-transparent focus:border-blue-500 ' value={underGroup} onChange={ handleUnderGroupChange}>
                                ...
                                <div className='input-ldgr flex ml-2' id='maintainBalancesBillByBill'>
                                    ...
                                    : <select name="maintainBalancesBillByBill" id="maintainBalancesBillByBill" value={maintainBalancesBillByBill} onChange={(e) => setMaintainBalancesBillByBill(e.target.value)}  className='w-[65px] font-semibold h-5 outline-none focus:bg-yellow-200 focus:border border border-transparent focus:border-blue-500 '>
                                ...
                                <div className='input-ldgr flex ml-2' id='defaultCreditPeriod'>
                                    ...
                                    : <input type="text" id='defaultCreditPeriod' name='defaultCreditPeriod' value={defaultCreditPeriod} onChange={(e) => setDefaultCreditPeriod(e.target.value)}  className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>
                                ...
                                <div className='input-ldgr flex mt-1 ml-2' id='typeOfDutyOrTax'>
                                    ...
                                    : <select name="typeOfDutyOrTax" id="typeOfDutyOrTax" value={typeOfDutyOrTax} onChange={(e) => setTypeOfDutyOrTax(e.target.value)} className='w-[165px] font-semibold h-5 outline-none focus:bg-yellow-200 focus:border border border-transparent focus:border-blue-500'>
                                ...
                                <div className='input-ldgr flex mt-1 ml-2' id='costsCentresAreApplicable'>
                                    ...
                                    : <select name="costsCentresAreApplicable" id="costsCentresAreApplicable" value={costsCentresAreApplicable} onChange={(e) => setCostsCentresAreAplicable(e.target.value)} className='w-[65px] font-semibold h-5 outline-none focus:bg-yellow-200 focus:border border border-transparent focus:border-blue-500 '>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                </div>
                                ...
                                <div className='input-ldgr flex ml-2' id='percentageOfCalculation'>
                                    ...
                                    : <input type="number" id='percentageOfCalculation' name='percentageOfCalculation' value={percentageOfCalculation} onChange={(e) => setPercentageOfCalculation(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>
                                ...
                                <div className='input-ldgr flex ml-2' id='hsnOrSac'>
                                    ...
                                    : <input type="text" id='hsnOrSac' name='hsnOrSac' value={hsnOrSac} onChange={(e) =>setHasnOrSac(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>
                                ...
                                <div className='input-ldgr flex ml-2' id='hsnOrSacDescription'>
                                    ...
                                    : <input type="text" id='hsnOrSacDescription' name='hsnOrSacDescription' value={hsnOrSacDescription} onChange={(e) => setHsnOrSacDescription(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>
                                ...
                                <div className='input-ldgr flex ml-2' id='sourceOfDetailsGst'>
                                    ...
                                    : <input type="text" id='sourceOfDetailsGst' name='sourceOfDetailsGst' value={sourceOfDetailsGst} onChange={(e) => setSourceOfDetailsGst(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>
                                ...
                                <div className='input-ldgr flex ml-2' id='igstRate'>
                                    ...
                                    : <input type="number" id='igstRate' name='igstRate' value={igstRate} onChange={(e) => setIgstRate(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>

                                <div className='input-ldgr flex ml-2' id='cgstRate'>
                                    <label htmlFor="cgstRate" className='mr-[198px]'>CGST Rate</label>
                                    : <input type="number" id='cgstRate' name='cgstRate' value={cgstRate} onChange={(e) => setCgstRate(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>

                                <div className='input-ldgr flex ml-2' id='utgstRate'>
                                    <label htmlFor="utgstRate" className='mr-[153px]'>SGST/UTGST Rate</label>
                                    : <input type="number" id='utgstRate' name='utgstRate' value={utgstRate} onChange={(e) => setUtgstRate(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>
                                ...
                                <div className='input-ldgr flex ml-2' id='alterRangeForChequeBooks'>
                                    ...
                                    : <select name="alterRangeForChequeBooks" id="alterRangeForChequeBooks" value={alterRangeForChequeBooks} onChange={(e) => setAlterRangeForChequeBooks(e.target.value)} className='w-[65px] font-semibold h-5 outline-none focus:bg-yellow-200 focus:border border border-transparent focus:border-blue-500 '>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                </div>
                                ...
                                <div className=' input-ldgr flex ml-2' id='enableChequePrinting'>
                                    ...
                                    : <select name="enableChequePrinting" id="enableChequePrinting" value={enableChequePrinting} onChange={(e) => setEnableChequePrinting(e.target.value)} className='w-[65px] font-semibold h-5 outline-none focus:bg-yellow-200 focus:border border border-transparent focus:border-blue-500 '>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                </div>
                                ...
                                <div className='input-ldgr flex ml-2 mt-3' id='contactPerson'>
                                    ...
                                    : <input type="text" id='contactPerson' name='contactPerson' value={contactPerson} onChange={(e) =>setContactPerson(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>
                                ...
                                <div className='input-ldgr flex ml-2' id='contactPhoneNumber'>
                                    ...
                                    : <input type="number" id='contactPhoneNumber' name='contactPhoneNumber' value={contactPhoneNumber} onChange={(e) =>setContactPhoneNumber(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>
                                ...
                                <div className='input-ldgr flex ml-2' id='mobileNumber'>
                                    ...
                                    : <input type="number" id='mobileNumber' name='mobileNumber' value={mobileNumber} onChange={(e) =>setMobileNumber(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>
                                ...
                                <div className='input-ldgr flex ml-2' id='email'>
                                    ...
                                    : <input type="text" id='email' name='email' value={email} onChange={(e) => setEmail(e.target.value)} className='h-5 capitalize outline-none pl-1 focus:bg-yellow-200 focus:border focus:border-blue-500' />
                                </div>
                            ...
                            <div className='h-[70vh] w-1/2 border text-sm'>
                                ...
                                <div className='input-ldgr ml-2' id='provideBankDetails'>
                                    ...
                                    : <select name="provideBankDetails" id="provideBankDetails" value={provideBankDetails} onChange={(e) => setProvideBankDetails(e.target.value)} className='w-[65px] font-semibold h-5 outline-none focus:bg-yellow-200 focus:border border border-transparent focus:border-blue-500'>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                </div>
                                ...
                                <div className='input-ldgr ml-2' id='setOrAlterGstDetails'>
                                    ...
                                    : <select name="setOrAlterGstDetails" id="setOrAlterGstDetails" value={setOrAlterGstDetails} onChange={(e) => setSetOrAlterGstDetails(e.target.value)} className='w-[65px] font-semibold h-5 outline-none focus:bg-yellow-200 focus:border border border-transparent focus:border-blue-500'>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                </div>
